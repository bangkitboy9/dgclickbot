...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("DOGE CLICK BOT".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("youtube : TOS TV")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"creative by : Aam Cescwallvine".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   ...
   UravxBuCwNMpYWTzKhRA(1)
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPn+"BOCAH PACIRAN SANGAR",end="\n\n")
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   ...
   try:
    ...
    pass
  UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Kopi udud siapkan dulu.....')
   ...
   if UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb)is not UpdateShortMessage:
    if UravxBuCwNMpYWTzKhRk(UravxBuCwNMpYWTzKhcb.message,'reply_markup')and UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb.message.reply_markup)is ReplyInlineMarkup:
     ...
     if UravxBuCwNMpYWTzKhco is not UravxBuCwNMpYWTzKhPH:
      UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Lagi nyari ads bosque....!')
      ...
      while UravxBuCwNMpYWTzKhPE:
       ...
       if UravxBuCwNMpYWTzKhcd==302:
        UravxBuCwNMpYWTzKhPf.write(UravxBuCwNMpYWTzKhPn+'[%s] STATUS: %s (%d)\r'%(UravxBuCwNMpYWTzKhPQ().strftime("%H:%M:%S"),'FALSE' if cc is not UravxBuCwNMpYWTzKhPH else 'Tunggu Sebentar Bosque.....!',UravxBuCwNMpYWTzKhcD))
        break
        ...
        UravxBuCwNMpYWTzKhPf.write(UravxBuCwNMpYWTzKhPn+'[%s] STATUS: %s (%d)\r'%(UravxBuCwNMpYWTzKhPQ().strftime("%H:%M:%S"),'Ada Captcha klik manual dulu bosque.....!' if cc is not UravxBuCwNMpYWTzKhPH else 'FALSE',UravxBuCwNMpYWTzKhcD))
